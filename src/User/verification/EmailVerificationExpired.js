...
export function EmailVerificationExpired(props) {
      ...
      <div className="pc-otp_screen">
        ...
        <div className="pc-verification">
          <img
            ...
            alt="Logo"
          ></img>
          	<h1 className=" text-dark mb-7" style={{fontSize:"30px", fontWeight: 600}}>Verify Expired!</h1>

          <div className="pc-text-muted pc-mt-5"
          style={{fontSize:"20px"}}>Your Signup email verification link has been expired.
