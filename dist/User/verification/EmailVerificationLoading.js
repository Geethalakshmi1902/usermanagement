...
exports.EmailVerificationLoading = EmailVerificationLoading;
...
function EmailVerificationLoading(props) {
  ...
  (0, _react.useEffect)(() => {
    ...
    _axios.default.get("verification-in-progress/" + code).then(resp => {
    ...
    }).catch(() => {// history("/verification-link-expired");
      // window.location.reload();
    });
  }, []);
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
        ...
        children: [/*#__PURE__*/(0, _jsxRuntime.jsx)("img", {
          ...
          children: "Your Email Verification Loading..."
        })]
      })]
    })
  });
